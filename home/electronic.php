...
<head>
    ...
    <link rel="icon" href="icon/electronic.png" type="image/icon type">
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li >
                    <a href="electronic.php" class="active"><span class="las la-laptop-code"></span>
                    <span>Electronic Devices</span></a>
                    
                    
                </li>
                <li >
                    <a href="clothes.php"><span class="las la-tshirt"></span>
